...
def _map_parquet_type_to_orso(parquet_type: str, logical_type: Optional[str] = None) -> str:
    """
...
def rugo_to_orso_schema(rugo_metadata: Dict[str, Any], schema_name: str = "parquet_schema") -> RelationSchema:
    """
...
def extract_schema_only(rugo_metadata: Dict[str, Any], schema_name: str = "parquet_schema") -> Dict[str, str]:
    """
